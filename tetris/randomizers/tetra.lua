-- A randomizer based on Tetra Legends
...
local TetraRandomizer = Randomizer:extend()

function TetraRandomizer:initialize()
...
function TetraRandomizer:generatePiece()
    local generated = nil
    while true do
